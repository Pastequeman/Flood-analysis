...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  # process the file
  # L = 107120
  write_csv(tibble(year = d, flow1 = yearly_fld[, 77954], flow2 = yearly_fld[,78671], flow3 = yearly_fld[, 80109], flow4 = yearly_fld[,81550]),
            paste0("./../OUT/etowah_", GCMS, EXP, ".csv"), append = TRUE)
