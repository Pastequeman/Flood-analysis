...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  # process the file
  # L = 107120
  write_csv(tibble(year = d, flow1 = yearly_fld[, 76525], flow2 = yearly_fld[,76526 ], flow3 = yearly_fld[,77245 ], flow4 = yearly_fld[, 77246]), 
            paste0("./../OUT/roanoke_", GCMS, EXP, ".csv"), append = TRUE)
