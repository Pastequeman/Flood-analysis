...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  # process the file
  # L = 107120
  write_csv(tibble(year = d, flow1 = yearly_fld[, 65682], flow2 = yearly_fld[,66402 ], flow3 = yearly_fld[,67122 ], flow4 = yearly_fld[, 67123]), 
            paste0("./../OUT/missourri_", GCMS, EXP, ".csv"), append = TRUE)
