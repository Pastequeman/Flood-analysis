...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  # process the file
  # L = 107120
  write_csv(tibble(year = d, flow1 = yearly_fld[, 82271], flow2 = yearly_fld[,82272], flow3 = yearly_fld[, 82991], flow4 = yearly_fld[,82992]),
            paste0("./../OUT/chatta_", GCMS, EXP, ".csv"), append = TRUE)
