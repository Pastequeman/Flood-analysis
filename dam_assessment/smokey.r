...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  write_csv(tibble(year = d,
                   flow1 = yearly_fld[, 73601],
                   flow2 = yearly_fld[, 74322],
                   flow3 = yearly_fld[, 72883],
                   flow4 = yearly_fld[, 73599],
                   flow5 = yearly_fld[, 73600],
                   flow6 = yearly_fld[, 73601],
                   flow7 = yearly_fld[, 73602],
                   flow8 = yearly_fld[, 74319],
                   flow9 = yearly_fld[, 74320],
                   flow10 = yearly_fld[, 74321],
                   flow11 = yearly_fld[, 74324]
                   ), 
            paste0("./../OUT/smokey_", GCMS, EXP, ".csv"), append = TRUE)
