...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  # process the file
  # L = 107120
  write_csv(tibble(year = d, flow1 = yearly_fld[, 79333], flow2 = yearly_fld[,79333], flow3 = yearly_fld[, 80053], flow4 = yearly_fld[, 80054],
                               flow5 = yearly_fld[,80057],flow6 = yearly_fld[,80778]),
            paste0("./../OUT/bill_william_", GCMS, EXP, ".csv"), append = TRUE)
