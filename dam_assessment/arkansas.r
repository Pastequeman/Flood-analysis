...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  # process the file
  # L = 107120
  write_csv(tibble(year = d, flow1 = yearly_fld[, 78651],
                   flow2 = yearly_fld[,78650],
                   flow3 = yearly_fld[,78649],
                   flow4 = yearly_fld[, 77929],
                   flow5 = yearly_fld[, 78650],), 
            paste0("./../OUT/arkansas_", GCMS, EXP, ".csv"), append = TRUE)
