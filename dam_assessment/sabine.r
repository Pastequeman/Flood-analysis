...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  write_csv(tibble(year = d,
                   flow1 = yearly_fld[,80807],
                   flow2 = yearly_fld[,80808],
                   flow3 = yearly_fld[,80809],
                   flow4 = yearly_fld[,80810],
                   flow5 = yearly_fld[,80811],
                   flow6 = yearly_fld[,80812],
                   flow7 = yearly_fld[,82252],
                   flow8 = yearly_fld[,82967],
                   flow9 = yearly_fld[,83688],
                   flow10 = yearly_fld[,83689],
                   flow11 = yearly_fld[,84407]), 
            paste0("./../OUT/sabine_", GCMS, EXP, ".csv"), append = TRUE)
