...
for (years in seq(YEAR_STA, YEAR_END, 1)) {
  ...
  # process the file
  # L = 107120
  write_csv(tibble(year = d, flow1 = yearly_fld[, 67113], flow2 = yearly_fld[,64952], flow3 = yearly_fld[,65671], flow4 = yearly_fld[, 65672]), 
            paste0("./../OUT/belle_", GCMS, EXP, ".csv"), append = TRUE)
